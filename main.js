...
document.querySelector("#cards").innerHTML =
    ...
    createCard("28/11", "quinta", createGame("brazil", "16:00", "switzerland")) +
...
document.querySelector("#cards2").innerHTML =
    ...
    createGame("senegal", "13:00", "holland") +
    createGame("united-stated", "16:00", "wales")) +
    ...
    createGame("holland", "13:00", "ecuador") +
    createGame("england", "16:00", "united-stated")) +
    ...
    createGame("holland", "12:00", "qatar") +
    createGame("iran", "16:00", "united-stated") +
